...
All items are subject to change based on community feedback and technical constraints.
...
- ✅ AUTO / ECO / OFFGRID / MANUAL / BOOST modes
- ✅ Web-based dashboard
- ✅ REST API
...
- ⚖️ Multi-load prioritization
- 🔒 Power limits per load
- 💰 Tariff-aware control logic
- 📈 Smarter anti-flicker algorithms
- 🎯 Export margin control (configurable deadband)
